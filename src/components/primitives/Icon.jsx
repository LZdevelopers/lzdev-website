...
const stroke = {
  utensils: (
    <>
      ...
      <path d="M7 2v20" />
      <path d="M21 2a5 5 0 0 0-5 5v6h5V2Z" />
      <path d="M21 13v9" />
    </>
  ),
  stethoscope: (
    <>
      <path d="M4 2H3a1 1 0 0 0-1 1v6a6 6 0 0 0 12 0V3a1 1 0 0 0-1-1h-1" />
  ...
  devices: (
    <>
      <path d="M18 8V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h6" />
      <path d="M6 21h4" />
      <path d="M16 10h4a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2h-4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2Z" />
    </>
  ),
  shield: (
    <>
  ...
  blocks: (
    <>
      ...
      <path d="M20 3h-6a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1Z" />
      <path d="M10 13H4a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-6a1 1 0 0 0-1-1Z" />
  ...
  ruler: (
    <>
      <path d="M16.5 2.5a2.12 2.12 0 0 1 3 3L6 19l-4 1 1-4 13.5-13.5Z" />
      <path d="m14 5 3 3M11 8l2 2M8 11l2 2M5 14l2 2" />
    </>
  ),
  userX: (
    <>
      ...
      <path d="m16.5 7.5 5 5M21.5 7.5l-5 5" />
    </>
  ),
  moon: <path d="M20.5 14.8A8.5 8.5 0 1 1 9.2 3.5a6.8 6.8 0 0 0 11.3 11.3Z" />,
  userCheck: (
    <>
      <path d="M14 20v-1.5a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4V20" />
      <circle cx="8" cy="7" r="4" />
      <path d="m16.5 10.5 2 2 4-4" />
    </>
  ),
  star: <path d="m12 2.6 2.9 6.1 6.6.9-4.8 4.7 1.2 6.6-5.9-3.2-5.9 3.2 1.2-6.6L2.5 9.6l6.6-.9L12 2.6Z" />,
  share: (
    <>
  ...
  palette: (
    <>
      <path d="M12 22a10 10 0 1 1 10-10c0 2-1 3-3 3h-2a2 2 0 0 0-2 2c0 .6.2 1.1.6 1.5.4.4.6.9.6 1.5 0 1.1-.9 2-2 2Z" />
      <circle cx="7.5" cy="11.5" r=".8" />
      <circle cx="11" cy="7.5" r=".8" />
      <circle cx="15.5" cy="10" r=".8" />
    </>
  ),
  terminal: (
    <>
  ...
  bug: (
    <>
      <path d="M14.5 4.5 16 2M9.5 4.5 8 2" />
      <path d="M6 9a6 6 0 0 1 12 0v5a6 6 0 0 1-12 0V9Z" />
      <path d="M2 13h4M18 13h4M3 7l3 2M21 7l-3 2M3 19l3-2M21 19l-3-2" />
    </>
  ),
  rocket: (
    <>
      <path d="M4.5 16.5c-1.5 1.3-2 5-2 5s3.7-.5 5-2c.7-.8.7-2 0-2.8a2 2 0 0 0-3 0Z" />
      <path d="M12 15l-3-3a22 22 0 0 1 8-10c2.5 0 4.5 2 4.5 4.5a22 22 0 0 1-9.5 8.5Z" />
      <path d="M9 12H4s.5-3 2-4h4" />
      <path d="M12 15v5s3-.5 4-2v-4" />
    </>
  ),
  lifebuoy: (
    <>
...
// Marcas — path único preenchido (fill), não traço.
// Geometria oficial (Simple Icons), embutida para não carregar uma biblioteca
// de ícones inteira só por dez logos.
const brand = {
  ...
  bootstrap:
    'M11.77 11.24H9.956V8.202h2.152c1.17 0 1.834.522 1.834 1.466 0 1.008-.773 1.572-2.174 1.572zm.324 1.206H9.957v3.348h2.231c1.459 0 2.232-.585 2.232-1.685s-.795-1.663-2.326-1.663zM24 11.39v1.218c-1.128.108-1.817.944-2.226 2.268-.4 1.319-.45 2.925-.55 4.5-.156 2.3-1.147 3.246-3.276 3.246H5.789c-2.13 0-3.121-.947-3.276-3.246-.1-1.575-.15-3.181-.55-4.5-.409-1.324-1.098-2.16-2.226-2.268V11.39c1.128-.108 1.817-.944 2.226-2.268.4-1.319.45-2.925.55-4.5C2.668 2.322 3.659 1.375 5.789 1.375h12.16c2.129 0 3.12.947 3.275 3.246.1 1.575.15 3.181.55 4.5.409 1.324 1.098 2.16 2.226 2.268zM16.877 14.19c0-1.524-1.075-2.57-2.66-2.746v-.078c1.164-.19 2.086-1.222 2.086-2.43 0-1.71-1.416-2.804-3.59-2.804H7.454v11.83h5.464c2.51 0 3.96-1.221 3.96-3.772z',
  typescript:
